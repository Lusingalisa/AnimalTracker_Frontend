  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const locationsResponse = await axios.get(`${import.meta.env.VITE_API_URL}/api/cattle/map-data`, {
          headers: { Authorization: `Bearer ${token}` },
        });
        
        // Fetch geofences
        const geofencesResponse = await axios.get(`${import.meta.env.VITE_API_URL}/api/geofences`, {
          headers: { Authorization: `Bearer ${token}` },
        });
